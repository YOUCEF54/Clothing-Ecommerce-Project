      ...
      {({ open }) => (
        ...
        <div className={`${(open)?`top-[3.59rem]`:`top-[-15rem]`} transition-all duration-500 ease-in-out w-full lg:hidden fixed z-10 bg-white border-b border-black`}>
          <div className="space-y-1 pt-2 pb-3 ">
            ...
            >
              <div className='flex  right-4 justify-end items-center ml-8 relative w-full'>
                <input type='text' placeholder='Search...' className=' w-full outline-none border p-2 rounded-md border-black  absolute' />
                <div className='z-10 cursor-pointer p-2 size-8 border mr-1 rounded-md border-black '>
                  <TbSearch />
                </div>
              </div>
              <div className='flex mx-3 justify-end gap-3 w-1/5'>
              <button className='px-2 py-1 border  border-neutral-600 rounded-md bg-white text-neutral-600 w-fit  '>Login</button>
              <button className='px-2 py-1 border rounded-md bg-neutral-600 text-white w-fit  '>sign up</button>
              </div>
            </div>
            <div
