...
export default function ModalCat() {
  ...
  return (
    <div>
        <button onClick={()=>setOpen(!open)} className='p-[9px] text-sm flex items-center gap-2 border border-gray-300 rounded'>
            Create Category
            <TbCategoryPlus className='text-base'/>
        </button>
                ...
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-indigo-100 sm:mx-0 sm:h-10 sm:w-10">
                      <TbCategory2 className="h-6 w-6 text-indigo-600" aria-hidden="true" />
                    </div>
